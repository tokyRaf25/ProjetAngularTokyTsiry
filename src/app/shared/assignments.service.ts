...
export class AssignmentsService {
  ...
  uri2 = "http://localhost:8010/api/getAssignments_Lib";
  ...
  getAssignment(id:number):Observable<Assignment> {
    ...
    .pipe(
      ...
      tap(a => {
        console.log("TRACE DANS TAP : j'ai reçu " + a.nomEleve);
      }),
      /*
      filter(a => {
        return (a.rendu)
  ...
  updateAssignment(assignment:Assignment):Observable<any> {
    ...
    this.loggingService.log(assignment.nomEleve, " a été modifié");
  ...
  deleteAssignment(assignment:Assignment):Observable<any> {
    ...
    */
    ...
    this.loggingService.log(assignment.nomEleve, " a été supprimé");
